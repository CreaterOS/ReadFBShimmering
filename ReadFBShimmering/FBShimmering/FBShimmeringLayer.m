...
- (void)_updateMaskColors
{
  ...
  /* 我们创建一个渐变以用作蒙版。在遮罩中，颜色无关紧要，由Alpha决定遮罩的程度 */
    
    /*
      即使使用了其他颜色也没有用 -- 无效
      UIColor *maskedColor = [UIColor yellowColor];
      UIColor *unmaskedColor = [UIColor yellowColor];
     */
